...
# Local Peering Gateway - 0214 VCN
...
output "peering_status" {
  description = "VCN Peering Gateway IDs (수동 연결 필요)"
  value = {
    lpg_0214_id = oci_core_local_peering_gateway.lpg_0214.id
    lpg_0213_id = oci_core_local_peering_gateway.lpg_0213.id
    note        = "Cross-tenancy peering requires manual connection via OCI Console or CLI"
  }
}
